 ...
 */
public class defaultSpinnerAdapter implements SpinnerAdapter, ListAdapter {
	 ...
	 * @param context
	 */
	public defaultSpinnerAdapter(SpinnerAdapter spinnerAdapter, int nothingSelectedLayout, Context context) {
	 ...
	 * @param context
	 */
	public defaultSpinnerAdapter(SpinnerAdapter spinnerAdapter, int nothingSelectedLayout,
